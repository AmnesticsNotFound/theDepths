    ...
    return (
        ...
        >
          ...
          <g id="Sky" className="sky">
            ...
            >
              <stop offset={0} style={{ stopColor: "#E6DBFA" }} />
              <stop offset="3.659654e-002" style={{ stopColor: "#E5DCFA" }} />
              <stop offset="0.5708" style={{ stopColor: "#D5EBFE" }} />
              <stop offset={1} style={{ stopColor: "#D0F0FF" }} />
            </radialGradient>
            <rect y={-1} className="st1" width={800} height={407} />
          </g>
          ...
          <g id="DarkWaves" className="DarkWaves">
            <g>
              ...
              >
                ...
                <stop offset="0.1789" style={{ stopColor: "#0020EC" }} />
                <stop offset="0.4149" style={{ stopColor: "#0043D7" }} />
                <stop offset="0.6374" style={{ stopColor: "#005CC8" }} />
                <stop offset="0.8386" style={{ stopColor: "#006CBF" }} />
          ...
          <g id="LightWaves" className="LightWaves">
            <g>
              ...
              >
                <stop offset={0} style={{ stopColor: "#0000FF" }} />
                <stop offset="0.1643" style={{ stopColor: "#0B2CF7" }} />
                <stop offset="0.3574" style={{ stopColor: "#1559F0" }} />
                <stop offset="0.5431" style={{ stopColor: "#4aadff" }} />
                <stop offset="0.7168" style={{ stopColor: "#4aadff" }} />
                <stop offset="0.874" style={{ stopColor: "#4aadff" }} />
                <stop offset={1} style={{ stopColor: "#4aadff" }} />
              </linearGradient>
              <path
                className="st3"
          ...
          <g id="WhiteWaves" className="WhiteWaves">
            <g className="st0">
              <path
                className="st4"
                d="M-71,220c94.2,0,94.2,18,188.4,18c94.2,0,94.2-18,188.4-18c94.2,0,94.2,18,188.4,18c94.2,0,94.2-18,188.4-18
              s94.2,18,188.4,18"
              />
            </g>
          </g>
